...
public class FAChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(FAChatActivity.this, RecyclerView.VERTICAL, false);
        ...
        continue_btn.setOnClickListener(v -> {
            Intent intent = new Intent(FAChatActivity.this, ExistingBusinessActivity.class);
        ...
        adapter = new ChatAdapter(messageChatModelList, FAChatActivity.this);
