...
public class ChatAdapter extends RecyclerView.Adapter {
    ...
    List<ChatModel> messageChatModelList;
    Context context;
    ...
    public ChatAdapter(List<ChatModel> messageChatModelList, Context context) {
    ...
    public int getItemViewType(int position) {
        ChatModel message = (ChatModel) messageChatModelList.get(position);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ChatModel message = messageChatModelList.get(position);
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder{
        ...
        void bind(ChatModel messageModel) {
